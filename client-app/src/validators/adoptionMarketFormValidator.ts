...
// import { addOrEditPetFormValidator } from './addOrEditPetFormValidator';

// export const adoptionMarketFormValidator = {
//     ...addOrEditPetFormValidator,
...
export const adoptionMarketFormValidator = combineValidators({
