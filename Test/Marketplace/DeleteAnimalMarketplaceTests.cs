namespace Tests.Animal
{
    ...
    [TestFixture]
    public class DeleteAnimalMarketplaceTests
    {
        private Mock<IRepository> repositoryMock;
        private Mock<IPhotoService> photoServiceMock;
        private Animal animal;
        private IEnumerable<AnimalMatch> matches;
        private DeleteAnimalMarketplaceCommand command;
        private DeleteAnimalMarketplaceCommandHandler handler;
        ...
        public void SetUp()
        {
            ...
            command = new DeleteAnimalMarketplaceCommand
            {
            ...
            handler = new DeleteAnimalMarketplaceCommandHandler(repositoryMock.Object, photoServiceMock.Object);
